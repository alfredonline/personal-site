export const translations = {
  en: {
    // Metadata
    'site_description': 'is a software engineer and amateur YouTuber focused on building language learning tools.',
  ...
  es: {
    // Metadata
    'site_description': 'es un ingeniero de software y YouTuber amateur enfocado en crear herramientas de aprendizaje de idiomas.',
    'site_title': 'Ingeniero de Software',
