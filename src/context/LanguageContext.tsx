...
const translations = {
  en: {
    ...
    'about_project': 'I built YouTubeToSlides.com, a user-friendly application that allows people to convert YouTube videos into presentations for educational purposes. To date, users from around the world have generated over 200 presentations with this tool.',
  ...
  es: {
    ...
    'about_project': 'Desarrollé YouTubeToSlides.com, una aplicación fácil de usar que permite a las personas convertir videos de YouTube en presentaciones con fines educativos. Hasta la fecha, usuarios de todo el mundo han generado más de 200 presentaciones con esta herramienta.',
